...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/roadquantum.git
cd roadquantum

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/roadquantum.git
